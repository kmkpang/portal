...
/**
 * BOOTSTRAP OVERRIDE TO FOUNDATION
 */

//TODO: Convert methods to Foundation equivalent and implement as plugin
//based on file [softverk-webportal/libraries/cms/html/bootstrap.php]

//Allows $debug to work without clashing with this pseudo class.
if(!JFactory::getApplication()->get("debug")) return;
...
abstract class JHtmlBootstrap
{
	...
	{
		return; // Disable until conversion is complete.
