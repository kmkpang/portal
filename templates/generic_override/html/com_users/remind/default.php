...
?>
<div class="forms--row row no-breadcrumbs row--agents-details remind <?php echo $this->pageclass_sfx?>">
	...
	<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="form-validate form-horizontal well">
		...
		<div class="form-field--row">
			<div class="contact__textbox-label">
				<button type="submit" class="input-submit primary-medium"><?php echo JText::_('JSUBMIT'); ?></button>
			</div>
		</div>
