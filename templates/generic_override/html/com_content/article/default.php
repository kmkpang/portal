...
$modules = JModuleHelper::getModules('articlesubmenu');
$leftHandSide = 0;
if (count($modules) > 0)
    $leftHandSide = 6;
$rightHandSide = 24 - $leftHandSide;

?>
<div class="article--main--wrapper row item-page<?php echo $this->pageclass_sfx; ?>" itemscope
...
if (count($modules) > 0){
?>
<div class="column large-6 article--submenu--wrapper">
    <?php
    }
...
<div class="column large-<?php echo $rightHandSide ?>">
    ...
    <?php if (!$this->print) : ?>
        <?php if ($canEdit || $params->get('show_print_icon') || $params->get('show_email_icon')) : ?>
            <div class="btn-group pull-right">
                <a class="btn dropdown-toggle" data-toggle="dropdown" href="#"> <span class="icon-cog"></span> <span
                        class="caret"></span> </a>
