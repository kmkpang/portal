  ...
  <div id="error">
    ...
    <p>
      ...
      if (($this->error->getCode()) == '404') {
        ...
        header('Location: ' . JUri::base() . 'not-found');
        exit;
        ...
        header('Location: ' . JRoute::_(JUri::base() . "index.php?option=com_webportal&view=fatalerror&message=" . base64_encode($this->error->getMessage())));
        exit;
