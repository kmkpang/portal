...
?>
<div class="registration forms--row row no-breadcrumbs<?php echo $this->pageclass_sfx?>">
	<div class="row pad">
					...
					<div class="form-actions">
						<div class="row">
							<div class="column small-24 medium-16">
								<button type="submit" class="input-submit primary-medium validate"><?php echo JText::_('JREGISTER');?></button>
							</div>
