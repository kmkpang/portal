 ...
 * @since  0.0.1
 */
class WebportalViewAgents extends JViewLegacy
{
    /**
    ...
    function display($tpl = null)
    {
        ...
        // Set the submenu
        WebportalHelper::addSubmenu('agents');
    ...
    {
        $title = JText::_('COM_WEBPORTAL_AGENTS_MANAGER');
        ...
        if ($this->canDo->get('core.create')) {
            JToolBarHelper::addNew('agents.add', 'JTOOLBAR_NEW');
        }
        if ($this->canDo->get('core.delete')) {
            JToolBarHelper::deleteList('', 'agents.delete', 'JTOOLBAR_DELETE');
        }
