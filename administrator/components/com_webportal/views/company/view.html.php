 ...
 * @since  0.0.1
 */
class WebportalViewCompany extends JViewLegacy
{
    protected $form;
    protected $item;
    protected $script;
    ...
    public function display($tpl = null)
    {
        ...
        WebportalHelper::addSubmenu('company');
    ...
    protected function addToolBar()
    {
        ...
        JToolBarHelper::title('Edit Company');
//        JToolBarHelper::cancel('company.cancel', 'Cancel');
