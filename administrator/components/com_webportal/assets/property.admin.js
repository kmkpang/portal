...
angular.module('webportal')
    .controller('PropertyAdminCtrl', ['$scope', '$http', '$log', '$sce', '$window', 'ngDialog', 'portal', 'events', 'localStorageService',
        function ($scope, $http, $log, $sce, $window, ngDialog, portal, events, localStorageService) { //dont think i need all these though !
            ...
            $scope.togglePublish = function (publish) {
                ...
                uploadUrl += "&property-id=" + $scope.property.property_id;
                ...
                $http.get(uploadUrl, {}).success(function (data) {
                    ...
                    if (data['success']) {
                        $scope.property.sent_to_web = data['message'];
