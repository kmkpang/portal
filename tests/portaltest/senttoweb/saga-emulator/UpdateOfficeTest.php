...
class UpdateOfficeTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    var $siteAddress = "atv.softverk.is";
    ...
    {
        $xml = file_get_contents(JPATH_BASE . DS . "tests/portaltest/testXml/officeUpdate.xml.xsl");
        $this->xmlString = $xml;
    }
    ...
    public function testUpdateOfficeOverWebService()
    {
