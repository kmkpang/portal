...
class SocialFacebookHelper
{
	...
	function render() {	
        ...
        switch($this->config['fb_data_source']) {
            case 'activity_feed' : require(JModuleHelper::getLayoutPath('mod_webportal_social', 'fbActivityFeed')); break;
           	case 'comments'      : {
	            ...
	            require(JModuleHelper::getLayoutPath('mod_webportal_social', 'fbComments')); 
            	break;
            }
            case 'facepile'      :  require(JModuleHelper::getLayoutPath('mod_webportal_social', 'fbFacepile')); break;
            case 'like_box'      :  require(JModuleHelper::getLayoutPath('mod_webportal_social', 'fbLikebox')); break;
            case 'recommendations': require(JModuleHelper::getLayoutPath('mod_webportal_social', 'fbRecommendations')); break;
            default              :  break;
        }
	}
}
