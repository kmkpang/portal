...
class SocialGPLusHelper
{
	...
	function render() {
        ...
        if($this->config['gplus_badge_style'] == 'standard_badge') {
            require(JModuleHelper::getLayoutPath('mod_webportal_social', 'gplusBadge')); 
        } else {
            require(JModuleHelper::getLayoutPath('mod_webportal_social', 'gplusIcon')); 
        }
	}
}
/* eof */