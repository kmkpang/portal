 ...
 * @since       1.6.0
 */
abstract class WpArticlesNewsHelper
{
	/**
	...
	public static function getList(&$params)
	{
        ...
        $item->linkText = $itemattribs->{'alternative_readmore'};
		    } else {
		        $item->linkText = JText::_('MOD_ARTICLES_NEWS_READMORE');
		    }
			}
			...
			$item->introtext = JHtml::_('content.prepare', $item->introtext, '', 'wp_articles_news.content');
