 ...
 * @since    2.5
 */
class Cleanagents extends JApplicationCli
{
    /**
    ...
    public function doExecute()
    {
        ...
        $this->sleepWait(10, "This will delete your existing sales ! press ctrl+c to stop...");


        WFactory::getLogger()->info("deleting jos_portal_sales");
        ...
        $query = 'delete from jos_portal_property_addresses where type_id=2';
        WFactory::getSqlService()->update($query);


        WFactory::getLogger()->info("deleting jos_portal_marketing_info");
        $query = 'delete from jos_portal_marketing_info where marketing_info_type_id=1';
        WFactory::getSqlService()->update($query);



        WFactory::getLogger()->debug("Sales cleaned...please resume websending..");
...
JApplicationCli::getInstance('Cleanagents')->execute();
