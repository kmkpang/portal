...
class Adjustpostlcodes extends JApplicationCli
{
    ...
    public function doExecute()
    {
        ...
        $query = "select * from  jos_geography_postal_codes";
        ...
        foreach ($result as $r) {
            ...
            if ($code < 150) {
                ...
                $postalDb->__id = $r['id'];
                $postalDb->__name_en = "$code - Reykjavik";
                $postalDb->__name_is = "$code - Reykjavik";
                $postalDb->__parent_id = $r['parent_id'];

                WFactory::getSqlService()->update($postalDb);
            }
