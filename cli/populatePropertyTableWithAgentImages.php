 ...
 * @since    2.5
 */
class Populatepropertytablewithagentimages extends JApplicationCli
{
    /**
    ...
    public function doExecute()
    {
        ...
        foreach ($properties as $p) {
             ...
             *
             */
            $agent = WFactory::getServices()->getServiceClass(__PROPPERTY_PORTAL_AGENT)->getAgent($p->__sale_id);
...
JApplicationCli::getInstance('Populatepropertytablewithagentimages')->execute();
