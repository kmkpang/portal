 ...
 * @since    2.5
 */
class UpdateFeatured extends JApplicationCli
{
    /**
    ...
    public function doExecute()
    {
        ...
        $this->sleepWait(5, "This will update your portal with is_featured ! press ctrl+c to stop...");


        WFactory::getLogger()->info("inserting is_featured in jos_portal_properties");
        $query = 'ALTER TABLE `jos_portal_properties` ADD `is_featured` TINYINT(1) NOT NULL DEFAULT \'0\' AFTER `virtual_tour`';
        WFactory::getSqlService()->update($query);

        WFactory::getLogger()->debug("Successful updated is_featured..");
...
JApplicationCli::getInstance('UpdateFeatured')->execute();
