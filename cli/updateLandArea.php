 ...
 * @since    2.5
 */
class UpdateLandArea extends JApplicationCli
{
    /**
    ...
    public function doExecute()
    {
        ...
        $this->sleepWait(5, "This will update your portal with land_area ! press ctrl+c to stop...");


        WFactory::getLogger()->info("inserting land_area in jos_portal_properties");
        $query = 'ALTER TABLE `jos_portal_properties` ADD `land_area` FLOAT NULL AFTER `living_area`';
        WFactory::getSqlService()->update($query);

        WFactory::getLogger()->debug("Successful updated land_area..");
...
JApplicationCli::getInstance('UpdateLandArea')->execute();
