 ...
 * @since    2.5
 */
class Cleanproperties extends JApplicationCli
{
    /**
    ...
    public function doExecute()
    {
        ...
        $this->sleepWait(10, "This will delete your existing properties ! press ctrl+c to stop...");
        ...
        $query = 'delete from jos_portal_property_addresses where type_id=1';
        WFactory::getSqlService()->update($query);
...
JApplicationCli::getInstance('Cleanproperties')->execute();
