<div class="form-contact" style="padding-top: 74px;">
    <div class="text-heading">
        <div name="contact" class="column small-24 heading" style="background-color: #f2f2f2; text-align: center;">
            ...
            <div id="contact-form" ng-controller="ContactForm">
                ...
                <form name="form" novalidate class="contact-form" method="post" ng-submit="submitContact()" ng-cloak>
                    ...
                    <div class="columns small-24 large-24">
                        ...
                        <div class="contact__form--row">
                            <label for="message"
                                class="contact__textbox-label"><?php echo JText::_("SUBJECT") ?></label>
