...
<div class="columns small-24 large-16">
    ...
    <div class="office-details__office-name"><?php echo $offices['office_name']; ?></div>
    <p>
    ...
    <span class="office-details__agent-name">
        <a href="<?php echo JUri::base() ?>agents"><?php echo JText::_("OUR AGENTS") ?></a>
    </span>

    <br/>
    <br/>

    <span class="office-details__maps-wrapper">
