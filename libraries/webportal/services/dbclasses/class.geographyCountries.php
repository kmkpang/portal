...
*
* -------------------------------------------------------
* CLASSNAME:        geographyCountries
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.geographyCountries.php
* FOR MYSQL TABLE:  jos_geography_countries
...
class PortalGeographyCountriesSql
{ // class : begin
...
var $__common_name;   // (normal Attribute)
var $__Language_name;   // (normal Attribute)
var $__language;   // (normal Attribute)
var $__capital;   // (normal Attribute)
var $__currency_code;   // (normal Attribute)
var $__currency_name;   // (normal Attribute)
var $__telephone_code;   // (normal Attribute)
var $__number;   // (normal Attribute)
var $__letter_code3;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_geography_countries";
    }
