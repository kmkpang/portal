...
*
* -------------------------------------------------------
* CLASSNAME:        portalProjectPlanType
* GENERATION DATE:  25.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalProjectPlanType.php
* FOR MYSQL TABLE:  jos_portal_project_plan_type
...
class PortalPortalProjectPlanTypeSql
{ // class : begin
...
var $__plan_type_id;   // (normal Attribute)
var $__plan_type;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_project_plan_type";
    }
