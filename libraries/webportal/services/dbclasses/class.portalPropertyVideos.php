...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyVideos
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyVideos.php
* FOR MYSQL TABLE:  jos_portal_property_videos
...
class PortalPortalPropertyVideosSql
{ // class : begin
...
var $__provider;   // (normal Attribute)
var $__description;   // (normal Attribute)
var $__alt;   // (normal Attribute)
var $__sequence;   // (normal Attribute)
...
var $database; // Instance of class database
    ...
    {
        return "jos_portal_property_videos";
    }
