...
*
* -------------------------------------------------------
* CLASSNAME:        portalSenttowebLog
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalSenttowebLog.php
* FOR MYSQL TABLE:  jos_portal_senttoweb_log
...
class PortalPortalSenttowebLogSql
{ // class : begin
...
var $__date;   // (normal Attribute)
var $__direction;   // (normal Attribute)
var $__fromip;   // (normal Attribute)
var $__toip;   // (normal Attribute)
var $__command;   // (normal Attribute)
var $__type;   // (normal Attribute)
var $__associated_id;   // (normal Attribute)
var $__realted_senttoweb_id;   // (normal Attribute)
var $__data;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_senttoweb_log";
    }
