...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertiesV2Compatibility
* GENERATION DATE:  08.03.2016
* CLASS FILE:       C:\xampp\htdocs\softverk-webportal\libraries\webportal\services\dbclasses\class.portalPropertiesV2Compatibility.php
* FOR MYSQL TABLE:  jos_portal_properties_v2_compatibility
* FOR MYSQL DB:     portal-generic
* -------------------------------------------------------
* CODE GENERATED BY:
...
class PortalPortalPropertiesV2CompatibilitySql
{ // class : begin
...
var $__v2_id;   // (normal Attribute)
var $__v2_unique_id;   // (normal Attribute)
...
var $database; // Instance of class database
    ...
    {
        return "jos_portal_properties_v2_compatibility";
    }
