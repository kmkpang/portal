...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyAddresses
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyAddresses.php
* FOR MYSQL TABLE:  jos_portal_property_addresses
...
class PortalPortalPropertyAddressesSql
{ // class : begin
...
var $__town_id;   // (normal Attribute)
var $__postal_code_id;   // (normal Attribute)
var $__address;   // (normal Attribute)
var $__address2;   // (normal Attribute)
var $__house_number;   // (normal Attribute)
var $__street;   // (normal Attribute)
...
var $database; // Instance of class database
    ...
    {
        return "jos_portal_property_addresses";
    }
