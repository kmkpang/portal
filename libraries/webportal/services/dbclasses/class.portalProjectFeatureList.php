...
*
* -------------------------------------------------------
* CLASSNAME:        portalProjectFeatureList
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalProjectFeatureList.php
* FOR MYSQL TABLE:  jos_portal_project_feature_list
...
class PortalPortalProjectFeatureListSql
{ // class : begin
...
var $__en_type;   // (normal Attribute)
var $__feature;   // (normal Attribute)
var $__en_feature;   // (normal Attribute)
var $__branch_id;   // (normal Attribute)
var $__order_group;   // (normal Attribute)
var $__order_item;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_project_feature_list";
    }
