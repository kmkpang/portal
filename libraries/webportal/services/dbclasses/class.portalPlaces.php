...
*
* -------------------------------------------------------
* CLASSNAME:        portalPlaces
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPlaces.php
* FOR MYSQL TABLE:  jos_portal_places
...
var $__uniqueid;   // (normal Attribute)
var $__name;   // (normal Attribute)
var $__latitude;   // (normal Attribute)
var $__longitude;   // (normal Attribute)
var $__original_property_id;   // (normal Attribute)
var $__original_latitude;   // (normal Attribute)
var $__original_longitude;   // (normal Attribute)
var $__distance_from_original_property;   // (normal Attribute)
var $__zip;   // (normal Attribute)
var $__image;   // (normal Attribute)
var $__link;   // (normal Attribute)
var $__category;   // (normal Attribute)
