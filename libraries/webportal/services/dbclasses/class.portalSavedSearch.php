...
*
* -------------------------------------------------------
* CLASSNAME:        portalSavedSearch
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalSavedSearch.php
* FOR MYSQL TABLE:  jos_portal_saved_search
...
class PortalPortalSavedSearchSql
{ // class : begin
...
var $__search_hash;   // (normal Attribute)
var $__search_model;   // (normal Attribute)
var $__search_result;   // (normal Attribute)
var $__hits;   // (normal Attribute)
var $__properties;   // (normal Attribute)
var $__agents;   // (normal Attribute)
var $__offices;   // (normal Attribute)
var $__is_valid;   // (normal Attribute)
var $__created;   // (normal Attribute)
var $__updated;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_saved_search";
    }
