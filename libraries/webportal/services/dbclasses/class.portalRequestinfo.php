...
*
* -------------------------------------------------------
* CLASSNAME:        portalRequestinfo
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalRequestinfo.php
* FOR MYSQL TABLE:  jos_portal_requestinfo
...
class PortalPortalRequestinfoSql
{ // class : begin
...
var $__contact_first_name;   // (normal Attribute)
var $__contact_last_name;   // (normal Attribute)
var $__contact_province;   // (normal Attribute)
var $__contact_phone;   // (normal Attribute)
var $__contact_email;   // (normal Attribute)
var $__contact_province_of_interest;   // (normal Attribute)
var $__contact_district_of_interest;   // (normal Attribute)
var $__how_do_you_know_us;   // (normal Attribute)
var $__interested_to_be;   // (normal Attribute)
var $__previous_realestate_experience;   // (normal Attribute)
var $__message;   // (normal Attribute)
var $__timestamp;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_requestinfo";
    }
