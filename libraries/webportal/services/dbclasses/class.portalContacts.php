...
*
* -------------------------------------------------------
* CLASSNAME:        portalContacts
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalContacts.php
* FOR MYSQL TABLE:  jos_portal_contacts
...
var $__contact_name;   // (normal Attribute)
var $__contact_category;   // (normal Attribute)
var $__contact_phone;   // (normal Attribute)
var $__contact_email;   // (normal Attribute)
var $__contact_city;   // (normal Attribute)
