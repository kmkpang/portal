...
*
* -------------------------------------------------------
* CLASSNAME:        portalProjects
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalProjects.php
* FOR MYSQL TABLE:  jos_portal_projects
...
var $__main_reg_id;   // (normal Attribute)
var $__developer_name;   // (normal Attribute)
var $__address_id;   // (normal Attribute)
var $__year_built;   // (normal Attribute)
var $__year_complete;   // (normal Attribute)
var $__land_size;   // (normal Attribute)
var $__remark;   // (normal Attribute)
var $__is_deleted;   // (normal Attribute)
var $__created_date;   // (normal Attribute)
var $__updated_date;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_projects";
    }
