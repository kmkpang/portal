...
*
* -------------------------------------------------------
* CLASSNAME:        portalProjectImageType
* GENERATION DATE:  25.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalProjectImageType.php
* FOR MYSQL TABLE:  jos_portal_project_image_type
...
class PortalPortalProjectImageTypeSql
{ // class : begin
...
var $__image_id;   // (normal Attribute)
var $__image_type;   // (normal Attribute)
var $__image_completion;   // (normal Attribute)
var $__image_url;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_project_image_type";
    }
