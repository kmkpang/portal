...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertiesUsers
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertiesUsers.php
* FOR MYSQL TABLE:  jos_portal_properties_users
...
class PortalPortalPropertiesUsersSql
{ // class : begin
...
var $__rating;   // (normal Attribute)
var $__exclusive;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_properties_users";
    }
