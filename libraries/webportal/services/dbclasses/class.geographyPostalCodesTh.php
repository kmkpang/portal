...
*
* -------------------------------------------------------
* CLASSNAME:        geographyPostalCodesTh
* GENERATION DATE:  23.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.geographyPostalCodesTh.php
* FOR MYSQL TABLE:  jos_geography_postal_codes_th
* FOR MYSQL DB:     portal-hofdaberg
* -------------------------------------------------------
* CODE GENERATED BY:
...
class PortalGeographyPostalCodesThSql
{ // class : begin
...
var $database; // Instance of class database
    ...
    {
        return "jos_geography_postal_codes_th";
    }
