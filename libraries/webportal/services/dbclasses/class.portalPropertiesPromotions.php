...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertiesPromotions
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertiesPromotions.php
* FOR MYSQL TABLE:  jos_portal_properties_promotions
...
class PortalPortalPropertiesPromotionsSql
{ // class : begin
...
var $__propertyId;   // (normal Attribute)
var $__startdatetime;   // (normal Attribute)
var $__enddatetime;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_properties_promotions";
    }
