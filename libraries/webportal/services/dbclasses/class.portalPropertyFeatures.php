...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyFeatures
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyFeatures.php
* FOR MYSQL TABLE:  jos_portal_property_features
...
class PortalPortalPropertyFeaturesSql
{ // class : begin
...
var $__feature_id;   // (normal Attribute)
var $__name_en;   // (normal Attribute)
var $__name_th;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_property_features";
    }
