...
*
* -------------------------------------------------------
* CLASSNAME:        portalProjectUnit
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalProjectUnit.php
* FOR MYSQL TABLE:  jos_portal_project_unit
...
class PortalPortalProjectUnitSql
{ // class : begin
...
var $__project_id;   // (normal Attribute)
var $__saga_unit_id;   // (normal Attribute)
var $__saga_type_id;   // (normal Attribute)
var $__units_name;   // (normal Attribute)
var $__unit_code;   // (normal Attribute)
var $__unit_size;   // (normal Attribute)
...
var $database; // Instance of class database
    ...
    {
        return "jos_portal_project_unit";
    }
