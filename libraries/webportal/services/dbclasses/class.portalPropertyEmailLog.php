...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyEmailLog
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyEmailLog.php
* FOR MYSQL TABLE:  jos_portal_property_email_log
...
class PortalPortalPropertyEmailLogSql
{ // class : begin
...
var $__datetime;   // (normal Attribute)
var $__fromip;   // (normal Attribute)
var $__type;   // (normal Attribute)
var $__subject;   // (normal Attribute)
var $__property_id;   // (normal Attribute)
var $__sender_email;   // (normal Attribute)
var $__receiver_email;   // (normal Attribute)
var $__message;   // (normal Attribute)
var $__fullemail;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_property_email_log";
    }
