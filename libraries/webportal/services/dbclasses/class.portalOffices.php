...
*
* -------------------------------------------------------
* CLASSNAME:        portalOffices
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalOffices.php
* FOR MYSQL TABLE:  jos_portal_offices
...
var $__public_key;   // (normal Attribute)
var $__unique_id;   // (normal Attribute)
var $__company_id;   // (normal Attribute)
...
var $__manager_id;   // (normal Attribute)
var $__certified_agent_id;   // (normal Attribute)
var $__logo;   // (normal Attribute)
