...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyFiles
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyFiles.php
* FOR MYSQL TABLE:  jos_portal_property_files
...
class PortalPortalPropertyFilesSql
{ // class : begin
...
var $__url;   // (normal Attribute)
var $__file_path;   // (normal Attribute)
var $__file_name;   // (normal Attribute)
...
var $database; // Instance of class database
    ...
    {
        return "jos_portal_property_files";
    }
