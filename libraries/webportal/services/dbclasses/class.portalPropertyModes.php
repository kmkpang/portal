...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyModes
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyModes.php
* FOR MYSQL TABLE:  jos_portal_property_modes
...
class PortalPortalPropertyModesSql
{ // class : begin
...
var $__description_is;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_property_modes";
    }
