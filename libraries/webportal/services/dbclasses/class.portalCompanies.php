...
*
* -------------------------------------------------------
* CLASSNAME:        portalCompanies
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalCompanies.php
* FOR MYSQL TABLE:  jos_portal_companies
...
class PortalPortalCompaniesSql
{ // class : begin
...
var $__company_name;   // (normal Attribute)
var $__company_address;   // (normal Attribute)
var $__postal_address;   // (normal Attribute)
var $__telephone;   // (normal Attribute)
var $__fax;   // (normal Attribute)
var $__email;   // (normal Attribute)
var $__ssn;   // (normal Attribute)
var $__legal;   // (normal Attribute)
var $__description;   // (normal Attribute)
