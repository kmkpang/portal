...
*
* -------------------------------------------------------
* CLASSNAME:        portalLogActions
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalLogActions.php
* FOR MYSQL TABLE:  jos_portal_log_actions
...
class PortalPortalLogActionsSql
{ // class : begin
...
var $__action;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_log_actions";
    }
