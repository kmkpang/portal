...
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.users.php
* FOR MYSQL TABLE:  jos_users
...
var $__username;   // (normal Attribute)
var $__email;   // (normal Attribute)
var $__password;   // (normal Attribute)
var $__block;   // (normal Attribute)
var $__sendEmail;   // (normal Attribute)
var $__registerDate;   // (normal Attribute)
var $__lastvisitDate;   // (normal Attribute)
var $__activation;   // (normal Attribute)
var $__params;   // (normal Attribute)
var $__lastResetTime;   // (normal Attribute)
var $__resetCount;   // (normal Attribute)
var $__otpKey;   // (normal Attribute)
var $__otep;   // (normal Attribute)
var $__requireReset;   // (normal Attribute)
