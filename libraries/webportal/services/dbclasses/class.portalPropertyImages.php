...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyImages
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyImages.php
* FOR MYSQL TABLE:  jos_portal_property_images
...
class PortalPortalPropertyImagesSql
{ // class : begin
...
var $__origin_url;   // (normal Attribute)
var $__server_url;   // (normal Attribute)
var $__image_file_name;   // (normal Attribute)
var $__description;   // (normal Attribute)
var $__alt;   // (normal Attribute)
var $__is_created;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_property_images";
    }
