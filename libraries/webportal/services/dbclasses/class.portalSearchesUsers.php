...
*
* -------------------------------------------------------
* CLASSNAME:        portalSearchesUsers
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalSearchesUsers.php
* FOR MYSQL TABLE:  jos_portal_searches_users
...
class PortalPortalSearchesUsersSql
{ // class : begin
...
var $__search_name;   // (normal Attribute)
var $__search_text;   // (normal Attribute)
var $__date;   // (normal Attribute)
var $__user_id;   // (normal Attribute)
var $__property_watch;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_searches_users";
    }
