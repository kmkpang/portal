...
*
* -------------------------------------------------------
* CLASSNAME:        portalProjectUnitType
* GENERATION DATE:  25.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalProjectUnitType.php
* FOR MYSQL TABLE:  jos_portal_project_unit_type
...
class PortalPortalProjectUnitTypeSql
{ // class : begin
...
var $__units_type_id;   // (normal Attribute)
var $__untis_type;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_project_unit_type";
    }
