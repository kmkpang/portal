...
*
* -------------------------------------------------------
* CLASSNAME:        portalPropertyViewingsUsers
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalPropertyViewingsUsers.php
* FOR MYSQL TABLE:  jos_portal_property_viewings_users
...
class PortalPortalPropertyViewingsUsersSql
{ // class : begin
...
var $__time;   // (normal Attribute)
var $__message;   // (normal Attribute)
var $__user_id;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_property_viewings_users";
    }
