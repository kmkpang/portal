...
*
* -------------------------------------------------------
* CLASSNAME:        portalSales
* GENERATION DATE:  30.03.2019
* CLASS FILE:       /Applications/MAMP/htdocs/softverk-webportal/libraries/webportal/services/dbclasses/class.portalSales.php
* FOR MYSQL TABLE:  jos_portal_sales
...
var $__first_name;   // (normal Attribute)
var $__middle_name;   // (normal Attribute)
var $__last_name;   // (normal Attribute)
var $__email;   // (normal Attribute)
var $__fax;   // (normal Attribute)
var $__phone;   // (normal Attribute)
var $__mobile;   // (normal Attribute)
var $__url_to_private_page;   // (normal Attribute)
var $__gender;   // (normal Attribute)
var $__SIN;   // (normal Attribute)
var $__DOB;   // (normal Attribute)
var $__language_spoken1;   // (normal Attribute)
var $__language_spoken2;   // (normal Attribute)
var $__language_spoken3;   // (normal Attribute)
var $__language_spoken4;   // (normal Attribute)
var $__language_spoken5;   // (normal Attribute)
var $__image_file_path;   // (normal Attribute)
var $__image_file_name;   // (normal Attribute)
var $__date_entered;   // (normal Attribute)
var $__date_modified;   // (normal Attribute)
var $__title;   // (normal Attribute)
var $__is_deleted;   // (normal Attribute)
var $__show_on_web;   // (normal Attribute)

var $database; // Instance of class database

    function getTableName()
    {
        return "jos_portal_sales";
    }
