                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                                                                ...
                                                                <table border="0" cellpadding="18" cellspacing="0"
                                                                       ...
                                                                       style="min-width: 100% !important;background-color: {{generic-primary-color-dark}};">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td valign="top" class="mcnTextContent"
                                                                            style="color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
                                                                            {{message}}
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                ...
                                <tr>
                                    <td valign="top">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="300"
                                            ...
                                            <?php foreach ($leftcolumn as $index => $leftHandSide) { ?>
                                                <tr>
                                                    <td valign="top" class="columnContainer">

                                                        <?php require $leftHandSide; ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="300"
                                            ...
                                            <?php foreach ($rightColumn as $index => $rightHandSide) { ?>
                                                <tr>
                                                    <td valign="top" class="columnContainer">

                                                        <?php require $rightHandSide; ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <div style="text-align: center;"><a
                                                                        href="http://www.softverk.is"
                                                                        target="_blank"><img align="none" height="98"
                                                                                             src="{{logo}}"
                                                                                             style="width: 146px; height: 98px; margin: 0px;"
                                                                                             width="146"></a><br>
                                                                    {{company_name}}
                                                                </div>
