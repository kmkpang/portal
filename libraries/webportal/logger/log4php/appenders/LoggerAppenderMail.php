...
//						"From: {$from}\r\n");
                    ...
                    $mailer->setSubject(" [ " . $config->get('sitename') . " / " . WFactory::getPublicIp() . " ] " . $subject);


                    $mailer->setBody($this->layout->getHeader() . $this->body . $this->layout->getFooter());
                    $mailer->Send();
